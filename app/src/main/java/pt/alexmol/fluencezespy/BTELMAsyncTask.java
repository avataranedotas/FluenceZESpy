                    ...
                    if (mmSocket2.isConnected() && READYtoRW2 && ELMREADY2 == 2) {
                        ...
                        */
                            ...
                            */
                            ...
                            if (tipobateria==1) {
                                ...
                                if (resposta != null && (resposta.length() == 128)) {
                                    ...
                                    longo = processalinha(resposta.substring(68, 72), 0, 15, false);
                                    if (longo != Long.MAX_VALUE) {
                                        publishProgress(114, (int) (longo*10));
                                    }

                                    //battery current
                                    longo = processalinha(resposta.substring(8, 12), 0, 15, true) * -1L;
                                    if (longo != Long.MAX_VALUE) {
                                        //if (Math.abs(longo) < 500) longo = 0;
                                        publishProgress(113, (int) (longo*5)  );
                                    }
                        ...
                        if (ciclo1m && !hsm) {
                            ...
                            resposta = getisoframe("744", "764", "022122",200 ,3);
                            ...
                            if (resposta != null && (resposta.length() == 48)) {
                                ...
                                //dimmer x2.5 %
                                longo = processalinha(resposta.substring(30, 32), 0, 7, false);
                                if (longo != Long.MAX_VALUE) {
                                    publishProgress(194, (int) longo);
                                }
                                ...
                                //temperatura motor +40
                                longo = processalinha(resposta.substring(46, 48), 0, 7, false);
                                if (longo != Long.MAX_VALUE) {
                                    publishProgress(196, (int) longo);
                                }
                            ...
                            //Nivel de Defeito de isolamento
                            resposta = getisoframe("7E4", "7EC", "0322330C",200 ,1);
                            ...
                            if (resposta != null && (resposta.length() == 16)) {
                                ...
                                if (longo != Long.MAX_VALUE) {
                                    publishProgress(193, (int) longo);
                                    //tostax("Total:" + longo);
                                }
                            }

                            //resistência de isolamento Ohm /100
                            resposta = getisoframe("7E4", "7EC", "032233EE",200 ,1);
                        ...
                        if (ciclo10s & !hsm) {
                            ...
                            */
                            ...
                            //total climate power
                            resposta = getisoframe("7E4", "7EC", "03223347", 200, 1);
                            ...
                            resposta = getisoframe("7E4", "7EC", "032233A7", 200, 1);
                            ...
                            */
                            ...
                            if (resposta != null && (resposta.length() == 16)) {
                                ...
                                longo = processalinha(resposta.substring(8, 14), 0, 23, true);
                                if (longo != Long.MAX_VALUE) {
